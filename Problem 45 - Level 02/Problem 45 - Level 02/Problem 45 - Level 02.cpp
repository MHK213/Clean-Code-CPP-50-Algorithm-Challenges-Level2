...
// Counts how many numbers are negative in the array
int CountNegativeNumbers(int arrSource[], int sourceLength) {
    int Count = 0;
...
int main()
{
    ...
    cout << "\nNegative Numbers Count is : " << CountNegativeNumbers(arr, arrLength1) << endl;
